...
export const ui = {
  en: {
    ...
    about: {
      ...
      status: 'running',
      events: [
        { year: '2019', text: 'Started studying Systems Analysis and Development at IFSP' },
        { year: '2019', text: 'Joined JJConsulting as an intern' },
        { year: '2020', text: 'Became a developer and embraced remote work during the pandemic' },
        { year: '2022', text: 'Graduated in Systems Analysis and Development from IFSP' },
        { year: '2025', text: 'Became a Tech Lead, raising the bar for teams, standards, and delivery' },
        { year: '2026', text: 'Became a Software Architect, designing systems built to evolve' },
      ],
    },
    contact: {
      cmd: 'contact',
  ...
  'pt-br': {
    ...
    about: {
      ...
      status: 'rodando',
      events: [
        { year: '2019', text: 'Iniciei o curso de Análise e Desenvolvimento de Sistemas no IFSP' },
        { year: '2019', text: 'Entrei na JJConsulting como estagiário' },
        { year: '2020', text: 'Tornei-me desenvolvedor e adotei o trabalho remoto durante a pandemia' },
        { year: '2022', text: 'Concluí o curso de Análise e Desenvolvimento de Sistemas no IFSP' },
        { year: '2025', text: 'Tornei-me Tech Lead, elevando o nível dos times, padrões e entregas' },
        { year: '2026', text: 'Tornei-me Arquiteto de Software, projetando sistemas feitos para evoluir' },
      ],
    },
    contact: {
      cmd: 'contato',
  ...
  es: {
    ...
    about: {
      ...
      status: 'ejecutando',
      events: [
        { year: '2019', text: 'Comencé la carrera de Análisis y Desarrollo de Sistemas en IFSP' },
        { year: '2019', text: 'Me incorporé a JJConsulting como pasante' },
        { year: '2020', text: 'Me convertí en desarrollador y adopté el trabajo remoto durante la pandemia' },
        { year: '2022', text: 'Me gradué en Análisis y Desarrollo de Sistemas por IFSP' },
        { year: '2025', text: 'Me convertí en Tech Lead, elevando el nivel de los equipos, estándares y entregas' },
        { year: '2026', text: 'Me convertí en Arquitecto de Software, diseñando sistemas preparados para evolucionar' },
      ],
    },
    contact: {
      cmd: 'contacto',
